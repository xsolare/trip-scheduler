...
const MOCK_PLANS: Plan[] = [
  { id: 1, name: 'Базовый', maxTrips: 3, maxStorageBytes: ONE_GIGABYTE_IN_BYTES, isDeveloping: false },
  { id: 2, name: 'Про', maxTrips: 50, maxStorageBytes: 20 * ONE_GIGABYTE_IN_BYTES, isDeveloping: false },
