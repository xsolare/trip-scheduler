...
import type { ActivitySectionGeolocation } from '~/components/03.features/trip-info/proposal-geolocation-section'
import type {
  ActivitySection,
...
import { GeolocationSection } from '~/components/03.features/trip-info/proposal-geolocation-section'
