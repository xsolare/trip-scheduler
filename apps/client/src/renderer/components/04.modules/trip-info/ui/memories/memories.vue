...
const store = useModuleStore(['data', 'ui', 'memories'])
const { getActivitiesForSelectedDay } = storeToRefs(store.data)
const { areAllMemoryGroupsCollapsed } = storeToRefs(store.ui)
