  ...
  <div class="geolocation-section">
    ...
    <div v-if="!readonly" class="geolocation-controls-panel">
      ...
      <div class="modes-group">
        <KitBtn variant="outlined" icon="mdi:cursor-move" aria-label="Режим панорамирования" @click="mode = 'pan'" />
        <KitBtn variant="outlined" icon="mdi:map-marker-plus" aria-label="Добавить точку кликом" @click="mode = 'add_point'" />
        <KitBtn variant="outlined" icon="mdi:routes" aria-label="Построить маршрут" @click="startNewRoute()" />
      </div>
    </div>
