...
const day1 = createDay(
  ...
  [
    createActivity('16:00-17:00', 'Прибытие в Аэропорт Хунцяо (SHA)', [createSection(EActivitySectionType.DESCRIPTION, 'Прибытие и трансфер в отель.')]),
    createActivity('17:00-18:15', 'Заселение в отель Yunhe Yebo Hotel', [
      createSection(EActivitySectionType.DESCRIPTION, 'Заселение, короткий отдых после перелета.'),
      createSection(EActivitySectionType.DESCRIPTION, 'Адрес: `2-5F, Area C, 1F, No.503 Wuning Road, Путуо, Шанхай`'),
    ]),
    createActivity('18:15-18:30', 'Путь к метро Caoyang Road', [
      ...
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250216013656.png']),
    ]),
    createActivity('18:30-19:30', 'Прогулка по парку Suzhouhe Mengqing Garden', [
      ...
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250216013458.png', '/images/3/20250221130326.png']),
    ]),
    createActivity('19:30-22:00', 'Ужин в Tian\'an Thousand Trees', [
      ...
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250216013213.png']),
    ]),
    createActivity('22:00-22:30', 'Возвращение в отель', [
      createSection(EActivitySectionType.DESCRIPTION, 'Поездка на метро обратно в отель для отдыха. \n\n**Важно:** Последние поезда метро отправляются примерно в 22:30-23:00!'),
    ]),
  ],
)
...
const day2 = createDay(
  ...
  [
    createActivity('10:00-10:30', 'Народная площадь и People\'s Park', [
      createSection(EActivitySectionType.DESCRIPTION, 'Начало дня с прогулки по центральному парку города (**People\'s Park 上海人民公园**).'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250217210256.png', '/images/3/20250217212046.png', '/images/3/20250217212501.png', '/images/3/20250217212416.png']),
    ]),
    createActivity('10:30-11:30', 'Прогулка по Nanjing Road Pedestrian Street', [
      createSection(EActivitySectionType.DESCRIPTION, 'Исследование главной торговой улицы Шанхая **(南京路步行街)**, проба местных закусок. Будьте готовы к толпам!'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250217213525.png', '/images/3/20250217213134.png', '/images/3/20250217222310.png']),
    ]),
    createActivity('11:30-13:00', 'Набережная Вайтан и мост Waibaidu', [
      createSection(EActivitySectionType.DESCRIPTION, 'Прогулка вдоль набережной с видом на небоскребы Пудуна, фото у исторического моста **Waibaidu Bridge** и в парке **North Bund Green Land (北外滩滨江绿地)**.'),
      createSection(EActivitySectionType.GALLERY, [
    ...
    createActivity('13:30-15:00', 'Обед', [
      createSection(EActivitySectionType.DESCRIPTION, 'Обед в районе **Changshou Rd. (长寿路)**, например, в **Miss Fu in Chengdu (付小姐在成都)**.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250217230124.png', '/images/3/20250217225444.png', '/images/3/20250217230103.png']),
    ]),
    createActivity('15:00-16:00', 'Посещение храма Нефритового Будды', [
      createSection(EActivitySectionType.DESCRIPTION, 'Визит в один из самых известных действующих буддийских храмов Шанхая **(Jade Buddha Temple 玉佛禅寺)**. Работает до 16:30.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250217230859.png', '/images/3/20250217223609.png']),
    ]),
    createActivity('17:10-18:50', 'Храм и парк Цзинъань (Jing\'an)', [
      createSection(EActivitySectionType.DESCRIPTION, 'Осмотр древнего храма **Jing\'an Temple (静安寺)**, который дал название всему району, и прогулка по прилегающему парку.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250220190555.png', '/images/3/20250220190346.png', '/images/3/20250220190301.png']),
    ]),
    createActivity('19:00-20:30', 'Ночная Nanjing Road', [
      createSection(EActivitySectionType.DESCRIPTION, 'Возвращение на главную пешеходную улицу, чтобы увидеть ее в сиянии неоновых огней.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250217232059.png', '/images/3/20250217232335.png']),
    ]),
  ],
)
...
const day3 = createDay(
  ...
  [
    createActivity('10:00-11:00', 'Дорога в Пудун', [
      createSection(EActivitySectionType.DESCRIPTION, 'Поездка на метро до станции **Lujiazui (陆家嘴)**, финансового центра Шанхая.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250313233958.png', '/images/3/20250313234517.png', '/images/3/20250313233753.png']),
    ]),
    createActivity('11:00-12:30', 'Подъем на небоскреб', [
      ...
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250313234400.png', '/images/3/20250313234435.png']),
    ]),
    createActivity('12:30-14:00', 'Обед в IFC Mall', [
      ...
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250313234851.png']),
    ]),
    createActivity('14:30-16:00', 'Прогулка по Century Park', [
      createSection(EActivitySectionType.DESCRIPTION, 'Крупнейший городской парк Шанхая **(世纪公园)** с озерами и садами. Вход: 10 юаней.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250314004804.png', '/images/3/20250314004824.png', '/images/3/20250314004848.png']),
    ]),
    createActivity('16:30-20:00', 'Прогулка по району и ужин', [
      createSection(EActivitySectionType.DESCRIPTION, 'Свободное время для исследования района и ужин в **Super Brand Mall (正大广场)**. Попробуйте **Shanghai Min (小南国)** для аутентичной шанхайской кухни.'),
    ]),
    createActivity('20:30-21:30', 'Вечерняя прогулка по набережной The Bund', [
      createSection(EActivitySectionType.DESCRIPTION, 'Возвращение на другую сторону реки, чтобы насладиться культовым видом на освещенные небоскребы Пудуна. Лучшие фото получаются именно отсюда!'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250314004632.png']),
    ]),
  ],
)
...
const day4 = createDay(
  ...
  [
    ...
    createActivity('13:00-14:00', 'Старый город и улица Fangbang', [
      createSection(EActivitySectionType.DESCRIPTION, 'Прогулка мимо Даосского храма городского божества **(上海城隍庙)** по старинной улочке **Fangbang Middle Road (方浜中路)**.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250309005739.png', '/images/3/20250309005903.png', '/images/3/20250309010228.png', '/images/3/20250309010246.png']),
    ]),
    createActivity('14:00-16:00', 'Прогулка и обед в Xintiandi', [
      createSection(EActivitySectionType.DESCRIPTION, 'Исследование пешеходного района **(新天地)** с домами "шикумен", где история встречается с современностью. Обед в одном из модных кафе.'),
      createSection(EActivitySectionType.GALLERY, [
    ...
    createActivity('16:30-19:00', 'Исследование района Tian Zi Fang', [
      ...
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250223152330.png', '/images/3/20250309174226.png']),
    ]),
  ],
)
...
const day5 = createDay(
  ...
  [
    createActivity('09:30-11:30', 'Дорога в Zhujiajiao', [
      createSection(EActivitySectionType.DESCRIPTION, 'Поездка на метро (17 линия) до древнего города на воде **(朱家角)**.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250309174651.png']),
    ]),
    createActivity('11:30-13:00', 'Исследование North Street и моста Fangsheng', [
      createSection(EActivitySectionType.DESCRIPTION, 'Прогулка по главной улице **(北大街)** с магазинами и чайными домиками, подъем на самый известный мост **Fangsheng Bridge (放生桥)** для панорамных видов.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250309181742.png']),
    ]),
    createActivity('13:00-15:00', 'Прогулка по турзоне и обед', [
      createSection(EActivitySectionType.DESCRIPTION, 'Обед в одном из ресторанов с видом на воду в **Shanghai Zhujiajiao Ancient Town Tourist Zone (上海朱家角古镇旅游区)**.'),
      createSection(EActivitySectionType.GALLERY, [
...
const day6 = createDay(
  ...
  [createActivity('10:00-22:00', 'Свободный день', [createSection(EActivitySectionType.DESCRIPTION, 'Этот день оставлен свободным для того, чтобы вы могли повторить то, что понравилось больше всего, или исследовать что-то новое по своему усмотрению.')])],
)
...
const day7 = createDay(
  ...
  [
    createActivity('09:20-10:20', 'Дорога до вокзала и поездка в Сучжоу', [
      createSection(EActivitySectionType.DESCRIPTION, 'Поездка на метро до вокзала **Hongqiao (虹桥火车站)** и 30-минутное путешествие на скоростном поезде.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250221144249.png']),
    ]),
    createActivity('11:20-13:00', 'Сад Скромного Чиновника', [
      createSection(EActivitySectionType.DESCRIPTION, 'Самый большой и знаменитый сад Сучжоу **(The Humble Administrator\'s Garden 拙政园)**. Вход: 70 CNY.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250221154010.png', '/images/3/20250221154201.png']),
    ]),
    createActivity('11:20-13:00', 'Альтернатива: Сад Львиного Леса', [
      createSection(EActivitySectionType.DESCRIPTION, 'Лабиринт из камней, напоминающих львов, в **Lion Grove Garden (狮子林)**. Вход: 40 CNY.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250221154416.png', '/images/3/20250221154551.png', '/images/3/20250221154742.png']),
    ]),
    createActivity('13:00-14:50', 'Прогулка и обед на Pingjiang Road', [
      createSection(EActivitySectionType.DESCRIPTION, 'Прогулка по мощеной исторической улице **Pingjiang Road** с чайными, мастерскими и сувенирными лавками. Обед в местной пельменной.'),
      createSection(EActivitySectionType.GALLERY, [
    ...
    createActivity('15:30-17:30', 'Tiger Hill Pagoda (Пагода на Тигрином холме)', [
      createSection(EActivitySectionType.DESCRIPTION, 'Посещение "китайской Пизанской башни" - древней наклонной пагоды **(云岩寺塔)** с богатой историей. \n\n[Видео обзор](https://youtu.be/V69OAJ2gE5E?si=iO74r6JVdQeTRT35)'),
      createSection(EActivitySectionType.GALLERY, [
    ...
    createActivity('17:30-19:42', 'Ужин и возвращение на вокзал', [
      createSection(EActivitySectionType.DESCRIPTION, 'Ужин перед отправлением обратно в Шанхай.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250221171445.png']),
    ]),
    createActivity('19:42-20:15', 'Скоростной поезд в Шанхай', [createSection(EActivitySectionType.DESCRIPTION, 'Возвращение в Шанхай.')]),
  ],
)
...
const day8 = createDay(
  ...
  [
    createActivity('11:00-12:00', 'Собор Сюйцзяхуэй (Xujiahui Cathedral)', [
      createSection(EActivitySectionType.DESCRIPTION, 'Посещение впечатляющего католического собора **(徐家汇天主堂)** в неоготическом стиле.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250223220410.png', '/images/3/20250216165042.png']),
    ]),
    createActivity('12:00-12:30', 'Библиотека Xujiahui Origin', [
      createSection(EActivitySectionType.DESCRIPTION, 'Посещение расположенной рядом живописной библиотеки **Xujiahui Origin Scenic Spot (徐家汇源景区)**.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250223220711.png', '/images/3/20250223231212.png']),
    ]),
    createActivity('12:30-14:00', 'Обед и шопинг в Metro-City', [
      createSection(EActivitySectionType.DESCRIPTION, 'Обед и прогулка по одному из самых узнаваемых торговых центров района **(美罗城)** с огромным шаром на крыше.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250223231820.png', '/images/3/20250223161225.png', '/images/3/20250223232114.png']),
    ]),
    createActivity('14:00-16:30', 'Прогулка по набережной Xuhui Riverside', [
      ...
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250223233156.png', '/images/3/20250216022953.png']),
    ]),
    createActivity('16:50-18:40', 'World Expo Cultural Park', [
      createSection(EActivitySectionType.DESCRIPTION, 'Прогулка по огромному парку **(世博文化公园)**, созданному на месте проведения Expo 2010.'),
      createSection(EActivitySectionType.GALLERY, [
    ...
    createActivity('18:40-20:30', 'Ужин в The River Mall и вид на China Art Museum', [
      createSection(EActivitySectionType.DESCRIPTION, 'Ужин в ТЦ **The River Mall (世博源)** и наслаждение ночным видом на подсвеченный **Дворец искусств Китая (中华艺术宫)** (бывший павильон Китая).'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250223235116.png', '/images/3/20250223202356.png', '/images/3/20250505090216.png', '/images/3/20250505090316.png']),
    ]),
  ],
)
...
const day9 = createDay(
  ...
  [
    createActivity('10:00-16:00', 'Свободное время', [createSection(EActivitySectionType.DESCRIPTION, 'Время для отдыха или самостоятельных прогулок.')]),
    createActivity('16:00-20:00', 'Представление в XUYAN Shanghai Signature Store', [
      ...
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250311220840.png']),
    ]),
...
const day10 = createDay(
  ...
  [createActivity('10:00-22:00', 'Свободный день', [createSection(EActivitySectionType.DESCRIPTION, 'Этот день оставлен свободным для того, чтобы вы могли отдохнуть, восстановиться и подготовиться к следующему этапу путешествия.')])],
)
...
const day11 = createDay(
  ...
  [
    createActivity('09:00-11:00', 'Дорога до вокзала и поездка в Ханчжоу', [
      createSection(EActivitySectionType.DESCRIPTION, 'Поездка на метро до вокзала **Hongqiao (虹桥火车站)** и путешествие на скоростном поезде (G-серия).'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250314010452.png', '/images/3/20250314010555.png', '/images/3/20250314010608.png']),
    ]),
    createActivity('11:30-14:00', 'Прогулка по озеру Сиху (West Lake)', [
      createSection(EActivitySectionType.DESCRIPTION, 'Осмотр озера **(西湖)**, включенного в список Всемирного наследия ЮНЕСКО, и прогулка по дамбе **Су (苏堤)**.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250314011414.png', '/images/3/20250314011512.png']),
    ]),
    createActivity('14:30-15:30', 'Посещение храма Линъинь (Lingyin Temple)', [
      createSection(EActivitySectionType.DESCRIPTION, 'Визит в один из самых знаменитых буддийских храмов Китая **(灵隐寺)**, известный своими статуями, вырезанными в скалах. Вход: 45 CNY.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250314011957.png', '/images/3/20250314011847.png']),
    ]),
    ...
    createActivity('21:21-22:22', 'Возвращение в Шанхай', [createSection(EActivitySectionType.DESCRIPTION, 'Поездка на скоростном поезде обратно в Шанхай.')]),
  ],
)
...
const day12 = createDay(
  ...
  [
    createActivity('09:30-11:00', 'Завтрак и выселение из отеля', [
      createSection(EActivitySectionType.DESCRIPTION, 'Собираем вещи, выселяемся из отеля. Можно попросить оставить багаж на ресепшене, если планируете еще погулять.'),
    ]),
    createActivity('11:00-13:00', 'Прощальная прогулка', [createSection(EActivitySectionType.DESCRIPTION, 'Свободное время для покупки сувениров или прогулки.')]),
    createActivity('14:00-17:05', 'Дорога в аэропорт и вылет', [createSection(EActivitySectionType.DESCRIPTION, 'Прибытие в Аэропорт Пудун (PVG) за 3 часа до вылета, регистрация на рейс и вылет.')]),
  ],
)
...
const day13 = createDay(
  ...
  [
    createActivity('00:20-01:30', 'Прилет в Урумчи и заселение в отель', [
      createSection(EActivitySectionType.DESCRIPTION, 'Ночное прибытие, трансфер на такси и заселение в **Atour Hotel (乌鲁木齐北京南路中营工地铁站亚朵酒店)**. [Отель на карте](https://j.map.baidu.com/10/dMWg)'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250506095740.png', '/images/3/0206a12000990mnse338F_W_1280_853_R5.webp', '/images/3/0206112000990n39g16CC_W_1280_853_R5.webp']),
    ]),
    createActivity('09:30-12:30', 'Поездка до Национального парка Тяньшань Тяньчи', [
      ...
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250506100018.png', '/images/3/202505031601413.png', '/images/3/unnamed.jpg']),
    ]),
    createActivity('12:30-17:00', 'Исследование Небесного озера (Тяньчи)', [
      ...
      createSection(EActivitySectionType.GALLERY, ['/images/3/tianchi2.jpg', '/images/3/depositphotos_139790534-stock-photo-xinjiang-china-may-09-2015.webp']),
    ]),
    createActivity('17:00-19:00', 'Возвращение в Урумчи', [
      createSection(EActivitySectionType.DESCRIPTION, 'Поездка на автобусе обратно в город. \n\n**Важно:** Уточните время отправления последнего автобуса при покупке билета! Обычно последние рейсы около 17:30-18:30.'),
    ]),
    createActivity('19:00-21:30', 'Вечерняя прогулка и ужин', [
      createSection(EActivitySectionType.DESCRIPTION, 'Прогулка по парку **Liyu Mountain Park (鲤鱼山公园)** напротив отеля и ужин в одном из местных ресторанов.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/B62a46a9b9ffe8860d.jpeg']),
    ]),
  ],
)
...
const day14 = createDay(
  ...
  [
    createActivity('09:00-10:00', 'Завтрак и выселение', [
      createSection(EActivitySectionType.DESCRIPTION, 'Позавтракать, собрать вещи и оставить их на хранение в отеле. \n\n*Фраза для ресепшена:* "Можно оставить багаж?" (可以寄存行李吗? - Kěyǐ jìcún xínglǐ ma?).'),
    ]),
    createActivity('10:30-11:30', 'Парк "Красная гора" (Hongshan Park)', [
      createSection(EActivitySectionType.DESCRIPTION, 'Осмотр парка **(红山公园)** и подъем на пагоду для панорамного вида на город.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250226210917.png', '/images/3/20250226211046.png', '/images/3/20250226211112.png']),
    ]),
    createActivity('11:30-12:30', 'Народный парк (People\'s Park)', [
      createSection(EActivitySectionType.DESCRIPTION, 'Прогулка по зеленому оазису в центре города **(乌鲁木齐人民公园)**.'),
      createSection(EActivitySectionType.GALLERY, ['/images/3/20250226211533.png', '/images/3/20250226211619.png', '/images/3/20250226212040.png']),
    ]),
