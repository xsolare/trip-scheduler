...
const variableNameToHumanReadable = (name: string) => {
  ...
  >
      ...
      <div class="theme-cards">
        ...
        >
          <div class="theme-card-preview theme-card-preview--light">
            ...
            <div class="preview-content">
              ...
              <div class="preview-element preview-element--small"></div>
            </div>
          </div>
          <div class="theme-card-info">
            ...
            <div class="theme-card-content">
              <h3 class="theme-card-title">Светлая тема</h3>
              <p class="theme-card-description">Классическое светлое оформление</p>
            </div>
            <div class="theme-card-check" v-if="activeThemeName === 'light'">
        ...
        >
          ...
          <div class="theme-card-info">
            ...
            <div class="theme-card-content">
              <h3 class="theme-card-title">Тёмная тема</h3>
              <p class="theme-card-description">Тёмное оформление для комфорта глаз</p>
            </div>
            <div class="theme-card-check" v-if="activeThemeName === 'dark'">
              <Icon icon="mdi:check-circle" />
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div class="theme-card-info">
            <div class="theme-card-main" @click="selectTheme('custom')">
              ...
              <div class="theme-card-content">
                <h3 class="theme-card-title">Своя тема</h3>
                <p class="theme-card-description">Создайте уникальное оформление</p>
              </div>
              <div class="theme-card-check" v-if="activeThemeName === 'custom'">
                <Icon icon="mdi:check-circle" />
              </div>
            </div>
    ...
    <div v-else class="theme-editor">
      ...
      <div class="theme-presets">
        <h4 class="presets-title">Вариации пресетов</h4>
      ...
      <div class="theme-editor-actions">
        ...
        <input ref="jsonInput" type="file" accept=".json" @change="handleJsonUpload" style="display: none;">
        <KitBtn 
          icon="mdi:restore" 
          variant="outlined" 
          color="secondary" 
...
.theme-chooser {
  ...
  .theme-card {
    ...
    &.active {
      ...
      box-shadow: 0 0 0 1px var(--border-pressed-color), 0 4px 20px var(--bg-overlay-primary-color);
    }
...
@media (prefers-color-scheme: dark) {
  .theme-card {
    ...
    &.active {
      box-shadow: 0 0 0 1px var(--border-pressed-color), 0 4px 20px var(--bg-action-hover-color);      
    }
  }
}
</style>
