CREATE TYPE "public"."activity_section_type" AS ENUM('description', 'gallery');--> statement-breakpoint
...
ALTER TABLE "days" ADD CONSTRAINT "days_trip_id_trips_id_fk" FOREIGN KEY ("trip_id") REFERENCES "public"."trips"("id") ON DELETE cascade ON UPDATE no action;